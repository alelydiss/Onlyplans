...
<head>
  ...
  <title>Onlyplans - Recuperar Contraseña</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" />
</head>
<body class="bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">

  <div class="w-full max-w-3xl shadow-lg rounded-xl overflow-hidden animate-fade-in bg-white dark:bg-gray-900 p-8 text-gray-800 dark:text-gray-100">
    ...
    <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">
      No hay problema. Solo indícanos tu correo electrónico y te enviaremos un enlace para que puedas restablecer tu contraseña.
    </p>
