                ...
                <div class="hidden md:flex items-center space-x-1">
                    @if (Auth::user()->role === 'admin')
                        ...
                        <a href="{{ route('admin.tickets') }}"
                            class="relative px-4 py-2 text-sm font-medium transition-all duration-300 group
                                {{ request()->routeIs('admin.tickets') ? 'text-purple-500 dark:text-purple-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                            <span class="relative z-10 flex items-center">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            ...
                            <span class="{{ request()->routeIs('admin.tickets') ? 'opacity-100' : 'opacity-0 group-hover:opacity-50' }} absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-purple-500/0 via-purple-500 to-purple-500/0 transition-opacity duration-300"></span>
                        </a>
                    @else
